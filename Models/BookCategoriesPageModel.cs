...
namespace Pusok_Beata_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryDate(Pusok_Beata_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Pusok_Beata_Lab8Context context,string[] selectedCategories,Book bookToUpdate)
        {
